...
namespace HomeOwner.Data.Migrations
{
    ...
    [Migration("20250510004233_AddDocumentModels")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomeOwner.Models.DocumentAccessLog", b =>
                {
                    ...
                    b.Property<string>("browser_info")
                        .IsRequired()
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("HomeOwner.Models.DocumentFolder", b =>
                {
                    b.Property<int>("folder_id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("folder_id"));
                    ...
                    b.Property<int?>("parent_folder_id")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("HomeOwner.Models.Document", b =>
                {
                    b.HasOne("HomeOwner.Models.DocumentFolder", "Folder")
                        .WithMany("Documents")
            ...
            modelBuilder.Entity("HomeOwner.Models.DocumentAccessLog", b =>
                {
                    b.HasOne("HomeOwner.Models.Document", "Document")
                        .WithMany("AccessLogs")
            ...
            modelBuilder.Entity("HomeOwner.Models.DocumentFolder", b =>
                {
                    b.HasOne("HomeOwner.Models.User", "Creator")
                        .WithMany("CreatedFolders")
                        .HasForeignKey("creator_id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("HomeOwner.Models.DocumentFolder", "ParentFolder")
            ...
            modelBuilder.Entity("HomeOwner.Models.User", b =>
                {
                    ...
                    b.Navigation("DocumentAccessLogs");
